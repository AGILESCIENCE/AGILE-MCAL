int plot_triggers_6(char *inpath="./tmp.root", char *outpath="./output.dat")
{
	// MM 08/04/15 parameterized input file, based on plot_triggers_4.C
	// MM 20/08/12 save trigger data to root file
	// MM 20/08/10 plot also cut0 (class A TGFs) as referencein canvas c2 and c3
	// MM 26/04/10 read file for Jun08-Mar10 data
	// MM 09/11/09 based on plot_triggers_3.C good for new format produced by macro add_geographic_info_3.C
...
//	ttrg.ReadFile("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/trg_2_005000-012585_processed.dat", "contact/I:id/I:t0/D:counts/I:hr/F:dt/F:lon/F:lat/F:h/F:etheta/F:ephi/F:year/I:month/I:day/I:hour/I:min/I:sec/I:usec/I:loctime/F:eavg/F:emax/F:boost/I:flag/I:tgflag/I:c0/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I");
	
	//ttrg.ReadFile("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/trg_2_005000-015154_processed.dat", 
	
	//ttrg.ReadFile("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/orbits_009564-19872_Feb2011/trg_2_009564-19872_processed_2.dat", "contact/I:id/I:t0/D:counts/I:hr/F:dt/F:lon/F:lat/F:h/F:etheta/F:ephi/F:year/I:month/I:day/I:hour/I:min/I:sec/I:usec/I:loctime/F:eavg/F:emax/F:boost/I:flag/I:tgflag/I:c0/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I");
	
	//ttrg.ReadFile("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/trg_2_019872-027208_processed_2.dat", "contact/I:id/I:t0/D:counts/I:hr/F:dt/F:lon/F:lat/F:h/F:etheta/F:ephi/F:year/I:month/I:day/I:hour/I:min/I:sec/I:usec/I:loctime/F:eavg/F:emax/F:boost/I:flag/I:tgflag/I:c0/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I");
	
	//ttrg.ReadFile("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_4/trg_4_005000-027208_processed_2.dat", "contact/I:id/I:t0/D:counts/I:hr/F:dt/F:lon/F:lat/F:h/F:etheta/F:ephi/F:year/I:month/I:day/I:hour/I:min/I:sec/I:usec/I:loctime/F:eavg/F:emax/F:boost/I:flag/I:tgflag/I:c0/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I");
	
	//ttrg.ReadFile("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/trg_2_027209-034543_processed_2.dat", "contact/I:id/I:t0/D:counts/I:hr/F:dt/F:lon/F:lat/F:h/F:etheta/F:ephi/F:year/I:month/I:day/I:hour/I:min/I:sec/I:usec/I:loctime/F:eavg/F:emax/F:boost/I:flag/I:tgflag/I:c0/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I");
	
	ttrg.ReadFile(inpath, "contact/I:id/I:t0/D:counts/I:hr/F:dt/F:lon/F:lat/F:h/F:etheta/F:ephi/F:year/I:month/I:day/I:hour/I:min/I:sec/I:usec/I:loctime/F:eavg/F:emax/F:boost/I:flag/I:tgflag/I:c0/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I");
...
ttrg.BuildIndex("contact","id");
//for (int j=0; j<100;j++) cout << ttrg.GetEntryNumberWithIndex(j) << endl;

// write trigger data to a root file
TFile *f = new TFile(outpath, "update");
//TFile *f = new TFile("trg_2_019872-027208_processed_2.root", "recreate");
ttrg.Write("triggers");
f->Close();
...
/*	while (ttrg.GetEntry(i++)) {
		if (atrg.boost == 0 && atrg.flag == 1 && atrg.counts>6 && atrg.hr>0.4 && atrg.h>0. && atrg.dt>0. && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7])/((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])) > -0.5 && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7])/((float)  (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]))<0.7 && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])/((float)(atrg.counts)) <= 2. && (atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1])/((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]))>-0.8 && (atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1])/((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]))<0.8 && (atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5])/((float)(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]))>-0.8 &&  (atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5])/((float)(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]))<0.8 && atrg.contact != 10553 && atrg.emax <= 100.) {
			//printf("%6d \t%20.6f \t%.6f \t%8.2f \t%8.2f \t%6d \t%8.2f \n", atrg.contact, atrg.t0, atrg.dt, atrg.lon, atrg.lat, atrg.counts, atrg.loctime);
			printf("%06d \t%20.6f \t%.6f\n", atrg.contact, atrg.t0, atrg.dt);	// good for makespectra
		}
	}*/

float hint[] = {1.e-6, 0.001, 0.003, 0.01, 0.03, 0.1, 0.3, 1., 2., 5., 10., 20., 50., 100., 200., 500., 1000., 2000., 5000., 10000., 20000., 50000., 100000., 200000., 500000., 1000000., 2.e6, 5.e6, 1.e7};
//float hint[] = {0.1, 0.2, 0.5, 1., 2., 5., 10., 20., 50., 100., 200., 500., 1000., 2000., 5000., 10000.}; // in minutes, like RHESSI catalog
TH1F *hdeltat = new TH1F("hdeltat", "hdeltat", 25, hint);
//TH1F *hdeltat = new TH1F("hdeltat", "hdeltat", 2000, 0., 1.e6);
double tp = 0.;
int i=0;

// cut8 && cut_top1 && !cut_deb1 && !cut_deb7; (relaxed selection, doubles statistics)
// NB: ci sono 6 eventi che hanno delta t = 0.
/*
while (ttrg.GetEntry(i++)) {
if (atrg.boost == 0 && atrg.flag == 1 && atrg.counts>6 && atrg.hr>0.4 && atrg.h>0. && atrg.dt>0. && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]) > -0.5 && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])<0.7 && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])/(atrg.counts) <= 2. && (atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3])>-0.8 && (atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3])<0.8 && (atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5])/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])>-0.8 &&  (atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5])/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])<0.8 && atrg.contact != 10553 && atrg.emax <= 100.) {
	printf("%6d \t%20.6f \t%.6f \t%8.2f \t%8.2f \t%6d \t%8.2f \n", atrg.contact, atrg.t0, atrg.dt, atrg.lon, atrg.lat, atrg.counts, atrg.loctime);
	hdeltat->Fill(atrg.t0 - tp); 
	tp = atrg.t0;
	}
}
*/

// cut3 && cut_top1 && !cut_deb1 ; (standard selection, escludi classe A, escludi trigger online, increase statistics)
/*while (ttrg.GetEntry(i++)) {if (atrg.boost == 0 && atrg.tgflag != 1 && atrg.flag != 1 && atrg.counts>9 && atrg.hr>0.5 && atrg.h>0. && atrg.dt>0. && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]) > -0.5 && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])<0.7 && (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])/(atrg.counts) <= 2. && (atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3])>-0.8 && (atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1])/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3])<0.8 && (atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5])/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])>-0.8 &&  (atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5])/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])<0.8 && atrg.contact != 10553 ) {
	 printf("%6d \t%20.6f \t%.6f \t%8.2f \t%8.2f \t%6d \t%8.2f \n", atrg.contact, atrg.t0, atrg.dt, atrg.lon, atrg.lat, atrg.counts, atrg.loctime);
	hdeltat->Fill(atrg.t0 - tp); 
	tp = atrg.t0;
	}	 
...
// cut0 && !cut_top1 (identifica i classe A non presenti nella B per motivi topologici)
/*while (ttrg.GetEntry(i++)) {
if (atrg.tgflag == 1 && (((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]) <= -0.5 || ((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])>=0.7 || 
((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]))/(atrg.counts) > 2. || ((float)(atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3])<=-0.8 || ((float)(atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3])>=0.8 || ((float)(atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5]))/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])<=-0.8 ||  ((float)(atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5]))/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7])>=0.8)) {
	printf("%6d \t%20.6f \t%.6f\n", atrg.contact, atrg.t0, atrg.dt);
	}
}
*/

// cut0 (classe A, stampa parametri di selezione e topologici)
/*while (ttrg.GetEntry(i++)) {
	if (atrg.tgflag == 1) {
		float p1p2asym = ((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]);
		float mult = ((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]))/(atrg.counts);
		float p1asym = ((float)(atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]);
		float p2asym = ((float)(atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5]))/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]);
		printf("%6d \t%20.6f \t%.6f \t%.2f \t%.2f \t%.2f \t%.2f \t%.2f \t%.2f \t%2d \t%2d \t%2d \t%2d\n", atrg.contact, atrg.t0, atrg.dt, atrg.counts, atrg.hr, p1p2asym, mult, p1asym, p2asym, atrg.c[0]+atrg.c[1], atrg.c[2]+atrg.c[3], atrg.c[4]+atrg.c[5], atrg.c[6]+atrg.c[7]);
	}
}
*/

// cut3 (classe B, esclusa classe A, vicino a un trigger online. Stampa parametri di selezione e topologici)
/*int nt=0;
float p1p2asym, p1asym, p2asym, mult;
while (ttrg.GetEntry(i++)) {
	p1p2asym = ((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]-atrg.c[4]-atrg.c[5]-atrg.c[6]-atrg.c[7]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]);
	mult = ((float)(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]+atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]))/(atrg.counts);
	if (atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]) {
		p1asym = ((float)(atrg.c[2]+atrg.c[3]-atrg.c[0]-atrg.c[1]))/(atrg.c[0]+atrg.c[1]+atrg.c[2]+atrg.c[3]);
	} else p1asym = -100.;
	if (atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]) {
		p2asym = ((float)(atrg.c[6]+atrg.c[7]-atrg.c[4]-atrg.c[5]))/(atrg.c[4]+atrg.c[5]+atrg.c[6]+atrg.c[7]);
	} else p2asym = -100.;
	
	if (atrg.boost == 0 && atrg.tgflag != 1 && atrg.flag != 1 && atrg.contact != 10553 && atrg.counts>9 && atrg.hr>0.5 && atrg.h>0. && atrg.dt>0. && p1p2asym>-0.5 && p1p2asym<0.7 && p1asym>-0.8 && p1asym<0.8 && p2asym>-0.8 && p2asym<0.8) {
		nt++;
		printf("%6d \t%20.6f \t%.6f \t%.2f \t%.2f \t%.2f \t%.2f \t%.2f \t%.2f\n", atrg.contact, atrg.t0, atrg.dt, atrg.counts, atrg.hr, p1p2asym, mult, p1asym, p2asym);
	}
}
cout << nt << endl;
*/

// cut12 && cut0 (classe A presenti nella lista di TGF con selezione visuale)
/*int nt=0;
xwhile (ttrg.GetEntry(i++)) {
	
	if (atrg.boost == 0 && atrg.tgflag != 1 && atrg.flag != 1 && atrg.contact != 10553 && atrg.counts>6 && atrg.hr>=0.4 && !(atrg.counts>9 && atrg.hr>=0.5) && atrg.h>0. && atrg.dt>0. && atrg.emax<40. && (atrg.c[0] + atrg.c[2]) > 0 && (atrg.c[1] + atrg.c[3]) > 0 && (atrg.c[4] + atrg.c[6]) > 0 && (atrg.c[5] + atrg.c[7]) > 0) {
		nt++;
...
// cut0 (TGF con selezione visuale NON presenti nella lista di classe A, e relativi parametri topologici)
/*int nt=0;
while (ttrg.GetEntry(i++)) {
	
	if (atrg.boost == 0 && atrg.tgflag == 1 && atrg.flag == 1 && !(atrg.contact != 10553 && atrg.counts>9 && atrg.hr>=0.5 && atrg.h>0. && atrg.dt>0. && atrg.emax<40. && (atrg.c[0] + atrg.c[2]) > 0 && (atrg.c[1] + atrg.c[3]) > 0 && (atrg.c[4] + atrg.c[6]) > 0 && (atrg.c[5] + atrg.c[7]) > 0)) {
		nt++;
		printf("%6d \t%20.6f \t%.6f \t%.2f \t%.2f \t%.2f \t%.2f \t%.2f \t%.2f \t%2d \t%2d \t%2d \t%2d\n", atrg.contact, atrg.t0, atrg.dt, atrg.counts, atrg.hr, atrg.lon, atrg.lat, atrg.loctime, atrg.emax, atrg.c[0] + atrg.c[2], atrg.c[1] + atrg.c[3], atrg.c[4] + atrg.c[6], atrg.c[5] + atrg.c[7]);
	}
}
cout << nt << endl;
*/
