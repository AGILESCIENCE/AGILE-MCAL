{
	...
	int trg[1000];	
	int flag[1000];
	float tbin[10]={0.1, 0.2, 0.5, 1., 2., 4., 8., 16., 32., 64.};		// time bin for labels (in ms)
	float sig[10][1000];
	float t90[10][1000];
	float pflux[10][1000];
	float counts[10][1000];
	float tgrbini[10][1000];
	float avgE[10][1000];
	
	TString filenames[10];
	filenames[0]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_1.dat";
	filenames[1]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_2.dat";
	filenames[2]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_5.dat";
	filenames[3]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_10.dat";
	filenames[4]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_20.dat";
	filenames[5]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_40.dat";
	filenames[6]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_80.dat";
	filenames[7]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_160.dat";
	filenames[8]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_320.dat";
	filenames[9]="/home/martino/data_analysis/VSB/64ms/analysis_081121/VSB_global_info_640.dat";
	...
	for (int i=0; i<10; i++) {
		...
		for (int j=0; j<nentries; j++) {
			tvsb.GetEntry(j);
			// main selection
			if ( atrg.t0 != t0prev ) {	// atrg.mint<-1. && fabs(atrg.tgrbini)<0.500 && atrg.counts>0  && atrg.cbkg>0
				...
				if (atrg.cbkg>0) {
					...
					avgE[i][nc] = atrg.avgE;
					pflux[i][nc] = atrg.cpeak/(atrg.tbin*1000.);	// counts/millisecond
				}
				else {
					sig[i][nc]= 0.;
					t90[i][nc] = 0.;
