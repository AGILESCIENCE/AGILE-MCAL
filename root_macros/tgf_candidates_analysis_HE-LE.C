{
	// MM 13/04/12 based on version _7: compare distributions for LE and HE TGFs
...
// 	mcalstyle->SetLabelSize(0.05, "Z");
	...
	ifstream fHE;
	fHE.open("/home/mcal/data_analysis/VSB/tgf_candidates_complete/highest_energy/t0_list_Mar09-Feb11_Ege30MeV.txt");
	int nHE = 0;
	int cHE;
	float dHE;
	float t0HE[100];
