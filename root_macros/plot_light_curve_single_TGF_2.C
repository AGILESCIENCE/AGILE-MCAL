plot_light_curve_single_TGF_2(int cont=17733, double t0=212942801.357960, double tg1=212942801.357986, double e1=238., double tg2=212942801.358373, double e2=45, double tg3=-1., double e3=-1.)
{	
// intestazione per TGF doppio grid 12809
//plot_light_curve_single_TGF_2(int cont=12809, double t0=182810695.148596, double tg1=182810695.149599, double e1=34., double tg2=182810695.149863, double e2=50, double tg3=-1., double e3=-1.)
	...
	double atbin = 0.0002;
	double azbefore = -0.006;
	double azafter  =  0.006;
	double atbkgini = -2.9;
	double atbkgfin  =  0.0;
