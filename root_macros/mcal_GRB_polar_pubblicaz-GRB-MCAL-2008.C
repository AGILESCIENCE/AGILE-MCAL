{
// localizations updated to 080607
...
gROOT->SetStyle("mcalstyle");
   ...
   int nptSWM=10;
   Double_t thetaSWM[20] = {166., 120., 77.9, 99.1, 110.16, 84.36, 155.43, 74.63, 113.6, 38.86};
   Double_t phiSWM[20]   = {353., 133., 274.1, 168.1, 355., 186.06, 143.67, 163.52, 201.0, 186.21};
   // GRB071020
   // GRB070714
   // GRB071112C
   // GRB071117
...
*/
   ...
   int nptIPM=7;
   Double_t thetaIPM[10] = {48.2, 135.8, 129., 67.7, 93.48, 72.82, 37.6};
   Double_t phiIPM[10]   = {88.3, 225.0, 315., 75.13, 209.35, 139.95, 1.12};
   // GRB070824 (SA)
   // GRB070825
   // GRB070915
   // GRB071125
...
*/
   ...
   int nptSA=2;
   Double_t thetaSA[5] = {19.9, 19.9};
   Double_t phiSA[5]   = {152.3, 152.3}; // baro: sono lo stesso punto ma altrimenti non fa il plot
   // GRB071104
