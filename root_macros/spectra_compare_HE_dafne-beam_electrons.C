...
char f_pre_beam[]="2522_BKG_E.root";
char f_beam[]="2522_BEAM_E.root";
float ti = 2000.;
float te = 1000.;
...
c2 = new TCanvas();
c2->Draw();
TH2F *haux2 = new TH2F("haux2", "", 100, 0.1, 3000., 100, 0.00001, 1.);
haux2->SetTitle("Background subtracted BEAM-ON MCAL reconstructed energy spectrum - normalized to 1");
haux2->GetXaxis()->SetTitle("Energy (MeV)");
haux2->GetYaxis()->SetTitle("Counts / s channel");
haux2->SetStats(0);
haux2->Draw();
gPad->SetLogx();
gPad->SetLogy();
