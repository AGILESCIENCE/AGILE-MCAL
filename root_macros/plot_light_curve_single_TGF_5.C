int plot_light_curve_single_TGF_5(int cont = 26226, double t0=264863788.626369, double dt=0.001164)
{	
...
*/	
	...
	double atbin = 0.00005;
	double azbefore = -0.002; //-0.006
	double azafter  =  0.002; // 0.006
	double atbkgini = -2.9;
	double atbkgfin  =  0.0;
	double tstart = -3.;
	double tstop  =  3.;
...
//	sprintf(cname, "/home/mcal/data_analysis/VSB/tgf_candidates_complete/highest_energy/%06d_%08d_%06d.gif", cont, ts.GetDate(), ts.GetTime());
	...
	sprintf(cname, "/home/mcal/data_analysis/VSB/tgf_candidates_complete/light_curves_trg4_selection01/%06d_%08d_%06d_200us.gif", cont, ts.GetDate(), ts.GetTime());
	c1.Print(cname);
