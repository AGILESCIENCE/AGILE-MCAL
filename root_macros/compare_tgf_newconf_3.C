int compare_tgf_newconf_3(int inicont=0, char *incat="/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/LE_TGF_newconf_PAPER_2.root", char * innew="/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/LE_TGF_newconf4.root") 
{
  // MM 26/10/15 add cut on h>0 to exclude events with bad reconstructed position
  // MM 23/10/15 @Duke based on compare_tgf_newconf_2.C compares pipeline results after 29/9 with 'enhanced' catalog results.
  ...
  c1->Print("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/tgf_distributions4.pdf");
  //c1->Print("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/tgf_distributions4.gif");
  //c1->Print("tgf_distributions.eps");
  c4->Print("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/rate4.pdf");  
  //c4->Print("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/rate4.gif");  
  

 // ------ print TGF list ------

  FILE *fo;
  fo = fopen("/home/mcal/data_analysis/VSB/offline_trigger_search/trigger_search_2/LE_TGF_newconf4.dat", "w");
  int j=0;
