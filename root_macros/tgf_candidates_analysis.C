...
// 	mcalstyle->SetLabelSize(0.05, "Z");
	...
	ifstream frhessi("/home/martino/data_analysis/VSB/tgf_candidates_Jun08-Mar09/tgflist_before-Jan-06.txt", ios_base::in);
	int nrh=0;
	int nsel=0;
	frhessi.clear();
	while (!frhessi.eof()) {
