{
	...
	double atbin = 0.0002;
	double azbefore = -0.0048;
	double azafter  =  0.0049;
	double atbkgini = -2.9;
	double atbkgfin  =  0.0;
	for (int i=0; i<20; i++) {
		tbin[i]    = atbin;
	...
	// maximum HR
	rootfilename[3] = new TString("/data1/mcal/MCAL_ARCHIVE/3908/root_file/RT007919_3908.root");
	...
	// shortest
	rootfilename[4] = new TString("/data1/mcal/MCAL_ARCHIVE/3908/root_file/RT007728_3908.root");
