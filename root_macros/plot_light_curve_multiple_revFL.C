{
//	include modifiche suggerite da Francesco Longo per l'articolo MCAL GRB 2008
	...
	char *label3[] = {"", "GRB 071125", "", "", "GRB 071227", "", "GRB 080319C", "GRB 080328", ""};
	...
	rootfilename[6] = new TString("/data2/mcalsw_output_FLIGHT/RT/RT004673_3908.root");
	t0[6] = 133014356.656;
	tbin[6] = 0.256 ;
	zbefore[6] = -10.;
	zafter[6] = 30.;
	
	rootfilename[7] = new TString("/data2/mcalsw_output_FLIGHT/RT/RT004798_3908.root");
	t0[7] = 133776179.856;
	tbin[7] = 0.256 ;
	zbefore[7] = -10.;
	zafter[7] = 30.;
	
	rootfilename[8] = new TString("/data2/mcalsw_output_FLIGHT/RT/RT004946_3908.root");
	t0[8] = 134685725.108208;
	tbin[8] = 0.256;
	zbefore[8] = -10.;
	zafter[8] = 30.;
...
*/
	...
	for (int i=0; i<9; i++) {
		...
		t2.DrawTextNDC(0.12, 0.12, label[i]);		
		
		TLatex t3;
		t3.SetTextSize(text_size);
		t3.DrawTextNDC(0.65, zpos, label3[i]);		
