{
	...
	TTree tvsb;
	tvsb.ReadFile("/home/martino/C_projects/workdir/BUILD_MCALSW_devel/root_macros/VSB_global_info_corr.dat", 	"runid/I:trg/I:t0/D:tstop/D:ttot/F:date/C:time/C:type/C:sa/I:lng/I:subms/I:nrm/I:rmid/I:sitid/I:lon/F:lat/F:h/F:dt/F:ntrg/I:mint/F:dt0/F:tgrbini/F:t90/F:counts/I:cpeak/I:avgE/F:nEbins/I:c0/I:c1/I:c2/I:c3/I:x1/I:x2/I:x3/I:x4/I:x5/I:x6/I:x7/I:x8/I:x9/I:x10/I:x11/I:x12/I:x13/I:x14/I:x15/I:z1/I:z2/I:z3/I:z4/I:z5/I:z6/I:z7/I:z8/I:z9/I:z10/I:z11/I:z12/I:z13/I:z14/I:z15/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I:c8/I");
	
	
	// tvsb.ReadFile("/home/martino/C_projects/workdir/BUILD_MCALSW_devel/root_macros/VSB_global_info_16ms-only.dat", 	"runid/I:trg/I:t0/D:tstop/D:ttot/F:date/C:time/C:type/C:sa/I:lng/I:subms/I:nrm/I:rmid/I:sitid/I:lon/F:lat/F:h/F:dt/F:ntrg/I:mint/F:dt0/F:tgrbini/F:t90/F:counts/I:cpeak/I:avgE/F:nEbins/I:c0/I:c1/I:c2/I:c3/I:x1/I:x2/I:x3/I:x4/I:x5/I:x6/I:x7/I:x8/I:x9/I:x10/I:x11/I:x12/I:x13/I:x14/I:x15/I:z1/I:z2/I:z3/I:z4/I:z5/I:z6/I:z7/I:z8/I:z9/I:z10/I:z11/I:z12/I:z13/I:z14/I:z15/I:c1/I:c2/I:c3/I:c4/I:c5/I:c6/I:c7/I:c8/I");
	
//tvsb.ReadFile("/home/martino/C_projects/workdir/BUILD_MCALSW_devel/root_macros/SW_global_info_corrected.dat", "runid/I:trg/I:t0/D:tstop/D:ttot/F:date/C:time/C:type/C:sa/I:lng/I:subms/I:nrm/I:rmid/I:sitid/I:lon/F:lat/F:h/F:dt/F:tgrbini/F:t90/F:counts/I:cpeak/I:avgE/F:nEbins/I:c0/I:c1/I:c2/I:c3/I:x1/I:x2/I:x3/I:x4/I:x5/I:x6/I:x7/I:x8/I:x9/I:x10/I:x11/I:x12/I:x13/I:x14/I:x15/I:z1/I:z2/I:z3/I:z4/I:z5/I:z6/I:z7/I:z8/I:z9/I:z10/I:z11/I:z12/I:z13/I:z14/I:z15/I");
	...
	// int florbit = new int[nflagged];
	// int fltrg = new int[nflagged];
	// int fltrg = new int[nflagged];
	...
	TH2F *hdtlon = new TH2F("hdtlon", "hdtlon", 12, 0., 360., 8, 0., 6000.);
	TH1F *hbars  = new TH1F("hbars", "hbars", 30, -0.5, 29.5);
	
	TH1F *ht90 = new TH1F("ht90", "ht90", 10000, 0., 1.);
	...
	TH1F *hmint = new TH1F("hmint", "hmint", 10000, -5., 5.);
	...
	for (int i=0; i<nentries; i++) {
		...
		int flag = 0;
		for (int j=0; j<nflagged; j++) {
			tspike.GetEntry(j);
			if (atrg.runid == aflg.runid && atrg.trg == aflg.trg) {
				if (strncmp(aflg.type, "BUS", 3)==0) flag=1;
				else flag=2;
				//cout << aflg.runid << "  " << atrg.trg << "  " << flag << endl;
				break;
			}
		}
		...
		//cout << i << endl;
		//if (atrg.counts > 25) tvsb.Show(i);
		//if (atrg.c1 + atrg.c2 >= 8) cout << atrg.runid << "  " << atrg.trg << "  " << atrg.c1 + atrg.c2 << endl;
		
	//	hr = (atrg.c1 + atrg.c2 + atrg.c3)/((float) atrg.counts);
	//	if (atrg.c0>0) {
	//		hr1 = (atrg.c1 + atrg.c2 + atrg.c3)/((float) atrg.c0);
	//	} else hr1 = 0.;
		
		
		//if (atrg.nrm == 1 && atrg.sitid == 1 && fabs(atrg.dt0)<0.01 && atrg.counts>0 ) {	// 16-ms only + selection on dt0 (good events only)
		//if (atrg.subms == 1 && fabs(atrg.dt0)<0.01 && atrg.counts>0  && atrg.nrm==0) {	// 16-ms only + selection on dt0 (good events only)
		//if (atrg.nrm == 1 && atrg.sitid == 0) {		// 1-ms 
		if (flag>0) {		
		//if (atrg.subms == 1  && atrg.nrm == 0  && atrg.runid>=5959  && atrg.runid<=6464) {	// sub-ms trg only
		//if (atrg.subms == 1 && atrg.dt>=4491. && atrg.dt<=5655.) {	// sub-ms trg & good time interval
		//if (atrg.nrm > 0 && atrg.sitid >= 1 && atrg.dt>=4491. && atrg.dt<=5655.) {	// sub-ms trg & good time interval
			hlon->Fill(atrg.lon);
			hdt->Fill(atrg.dt);		
			hdtlon->Fill(atrg.lon, atrg.dt);
			hmint->Fill(atrg.dt0+atrg.mint);
			//if (atrg.dt0+atrg.mint<-2.) cout << i << endl;
			if (flag == 1) {
				hdt1->Fill(atrg.dt);	// sure spikes
				hlon1->Fill(atrg.lon);
			}
			if (flag == 2) {
				hdt2->Fill(atrg.dt);	// everything else
				hlon2->Fill(atrg.lon);
			}
			
			if (flag == 2 && atrg.dt>=3000 && atrg.subms == 1 && fabs(atrg.dt0)<0.01 && atrg.counts>0  && atrg.nrm==0) {
