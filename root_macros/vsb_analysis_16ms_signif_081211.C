{
	...
	int flag[10000];
	double t0[10000];
	float tbin[6]={0.5, 1., 2., 4., 8., 16.};		// time bin for labels (in ms)
	float sig[4][10000];
	float t90[4][10000];
	float pflux[4][10000];
	float counts[4][10000];
	float dt0[4][10000];
	float tgrbini[4][10000];
	float avgE[4][10000];
	float hr[4][10000];
	
	TString filenames[4];

	filenames[0]="/data1/mcal/data_analysis/VSB/analysis_08-12-11_16ms/VSB_global_info_5.dat";
	filenames[1]="/data1/mcal/data_analysis/VSB/analysis_08-12-11_16ms/VSB_global_info_10.dat";
	filenames[2]="/data1/mcal/data_analysis/VSB/analysis_08-12-11_16ms/VSB_global_info_20.dat";
	filenames[3]="/data1/mcal/data_analysis/VSB/analysis_08-12-11_16ms/VSB_global_info_40.dat";
