...
// 	mcalstyle->SetLabelSize(0.05, "Z");
	...
	TH1F *hhr = new TH1F("hhr", "hhr", 50, -0.01, 9.99);
	...
	TH1F *hhrBUS = new TH1F("hhrBUS", "hhrBUS", 50, -0.01, 9.99);
	...
	for (int i=0; i<nentries; i++) {
		...
		if (atrg.t0 != t0prev && atrg.mint<-24.  ) {//&& (atrg.runid<7302 || atrg.runid>7342) && (atrg.runid<6068 || atrg.runid>6140)
			...
			hr = (atrg.c[1] + atrg.c[0] + atrg.b[1] + atrg.b[0])>0 ? ((float) (atrg.c[2] + atrg.c[3] + atrg.b[2] + atrg.b[3])) / (atrg.c[1] + atrg.c[0] + atrg.b[1] + atrg.b[0]) : 0.;
