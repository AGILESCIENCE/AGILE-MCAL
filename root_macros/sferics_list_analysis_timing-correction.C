{
	...
	char bstpath[] = "/home/mcal/data_analysis/VSB/sferics_correlation/wrong_timing/0908/";
	char listfile[] = "/home/mcal/data_analysis/VSB/sferics_correlation/wrong_timing/0908/tgf-130809_time-corrected.lst";
	...
	while (!in.eof()) {
		...
		if (k<n) {
			...
			for (int i=1; i<=500000; i++) {
				...
				icor = i + 36550; // dt = 0.036550;
				hs->SetBinContent(icor, efield);
			}
			float xlo = -0.024;
			float xhi =  0.024;
