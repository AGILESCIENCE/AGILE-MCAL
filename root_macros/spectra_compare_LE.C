...
char datadir[]="/data1/mcalsw_output/H/";
...
char f_iasf[]="3785_sel_15_E.root";
char f_laben1[]="3785_sel_17_E.root";
...
TH2F *hb = new TH2F("hb", "hb", 1000, .1, 4., 1000, 0., 1000.);
hb->Draw();
...
leg->AddEntry(hi, "without bar equalization", "l");
leg->AddEntry(he, "with bar equalization", "l");
leg->Draw();
