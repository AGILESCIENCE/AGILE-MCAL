...
int add_geographic_info_5(char *inpath="./tmp.root", char *outpath="./output.dat")
{
	// MM 29/07/2015 fake processing for tgf3.py pipeline, workaround after PPSE failure on Jul 1st 2015.
	// retain only proximity check with trigger list. No geographic info added. 
...
/* // no more check on catalog events (already obsolete)
