...
// 	mcalstyle->SetLabelSize(0.05, "Z");
	...
	TH1F *ht90 = new TH1F("ht90", "ht90", 1000, 0., 1.);
	...
	TH1F *ht90BUS = new TH1F("ht90BUS", "ht90BUS", 1000, 0., 1.0);
		...
		if (1 ) {
			...
			if (hr >= 1.3 ) {
				...
				hdtlon->Fill(atrg.lon<=180. ? atrg.lon : atrg.lon-360., atrg.dt);		
					...
					gcntbarGRB->SetPoint(ncGRB, atrg.counts, hr);
