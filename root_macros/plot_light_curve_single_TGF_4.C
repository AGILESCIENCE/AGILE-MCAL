plot_light_curve_single_TGF_4(int cont=12809, double t0=182810695.148596, double tg1=182810695.149599, double e1=34., double tg2=182810695.149863, double e2=50, double tg3=-1., double e3=-1.)
{	
	...
	TCanvas c1("c1", "c1", 800, 600);//800,1000
