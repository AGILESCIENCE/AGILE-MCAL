...
file_trg = "/home/mcal/BUILD_MCALSW.BUILD15-devel/scripts/trg4_" + sys.argv[1] + "-" + sys.argv[2] +".dat"
file_trg_proc = "/home/mcal/BUILD_MCALSW.BUILD15-devel/scripts/trg_proc4_" + sys.argv[1] + "-" + sys.argv[2] +".dat"
file_trg_root = "/home/mcal/BUILD_MCALSW.BUILD15-devel/scripts/trg_proc4_" + sys.argv[1] + "-" + sys.argv[2] +".root"
file_tgf_root = "/home/mcal/BUILD_MCALSW.BUILD15-devel/scripts/LE_TGF_newconf4_" + sys.argv[1] + "-" + sys.argv[2] +".root"
