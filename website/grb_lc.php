...
<head>
  ...
  function loadData()
  {
    ...
    //./grb_lc.php?file_name="+file_name+"&t0="+t_zero+"&=orbit_number"+orbit_number
    var file_name = "<?php echo $_GET['file_name'] ?>";
    var t_zero = "<?php echo $_GET['t_zero'] ?>";
    var orbit_number = "<?php echo $_GET['orbit_number'] ?>";

    console.log('../mcaldata/'+orbit_number+"/GRB/"+file_name);
    var img = document.createElement('img');
    img.src = '../mcaldata/'+orbit_number+"/GRB/"+file_name;
    img.className = "img-responsive";
    document.getElementById('lc-image').appendChild(img);

    //ssh  document.getElementById("label").innerHTML = "GRB - Orbit Number= "+orbit_number+" T0= "+t_zero;
    ...
    <div class="container-fluid">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="grb.html">GRB</a></li>
