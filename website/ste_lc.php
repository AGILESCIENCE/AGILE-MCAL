...
<script type="text/javascript" charset="utf8" src="DataTables/responsive.bootstrap.min.js"></script>
  ...
  function loadData()
  {
    ...
    console.log(t_zero);
    console.log('../mcaldata/'+orbit_number+"/STE/"+file_name);
    var img = document.createElement('img');
    img.src = '../mcaldata/'+orbit_number+"/STE/"+file_name;
    img.className = "img-responsive";
    document.getElementById('lc-image').appendChild(img);

  //    document.getElementById("label").innerHTML = "STE - Orbit Number= "+orbit_number+" T0= "+t_zero+" Trigger Number= "+trigger_number ;
    ...
    <div class="container-fluid">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="ste.html">STE</a></li>
